  ...
  (function() {
    ...
    exports.Rewriter = (function() {
      ...
      Rewriter.prototype.addImplicitIndentation = function() {
        ...
        condition = function(token, i) {
          var _ref, _ref1;
          return token[1] !== ';' && (_ref = token[0], __indexOf.call(SINGLE_CLOSERS, _ref) >= 0) && !(token[0] === 'ELSE' && starter !== 'THEN') && !(((_ref1 = token[0]) === 'CATCH' || _ref1 === 'FINALLY') && (starter === '->' || starter === '=>' || starter === '!->' || starter === '!=>'));
        };
        action = function(token, i) {
