...
(function() {
  var Access, Arr, Assign, Base, Block, Call, Class, Closure, Code, CodeFragment, Comment, Existence, Extends, For, IDENTIFIER, IDENTIFIER_STR, IS_STRING, If, In, Index, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, METHOD_DEF, NEGATE, NO, Obj, Op, Param, Parens, RESERVED, Range, Return, SIMPLENUM, STRICT_PROSCRIBED, Scope, Slice, Splat, Switch, TAB, THIS, Throw, Try, UTILITIES, Value, While, YES, addLocationDataFn, compact, del, ends, extend, flatten, fragmentsToText, last, locationDataToString, merge, multident, some, starts, throwSyntaxError, unfoldSoak, utility, walk, _ref, _ref1, _ref2, _ref3;
  ...
  exports.Base = Base = (function() {
    ...
    Base.prototype.subst = function(replacements) {
      exports.walk(this, function(n) {
        var i, tmp, type, _i, _len, _ref2, _ref3, _ref4, _ref5, _ref6;
        _ref2 = ['index', 'name', 'source'];
        for (type = _i = 0, _len = _ref2.length; _i < _len; type = ++_i) {
          i = _ref2[type];
          if ((i || (n.source != null)) && (tmp = (_ref3 = n[type]) != null ? _ref3.value : void 0) && (tmp = replacements[tmp])) {
            n[type].value = tmp;
          }
        }
        if ((tmp = ((_ref4 = n.variable) != null ? (_ref5 = _ref4.base) != null ? _ref5.value : void 0 : void 0) || ((_ref6 = n.base) != null ? _ref6.value : void 0)) && ((tmp = replacements[tmp]) != null)) {
          return tmp;
        }
      });
      return this;
  ...
  exports.Block = Block = (function(_super) {
    ...
    Block.prototype.compileRoot = function(o) {
      var exp, i, name, prelude, preludeExps, rest, _i, _len, _ref2;
      o.indent = '';
      ...
      if (!o.bare) {
        ...
        rest.noRoot = true;
        rest = new Value(rest);
        this.expressions = [new Call(rest)];
      }
      return [].concat(prelude, this.compileWithDeclarations(o));
    };
  ...
  exports.Assign = Assign = (function(_super) {
    ...
    Assign.prototype.upScopes = 0;

    Assign.prototype.compileNode = function(o) {
      var answer, compiledName, match, name, scope, val, varBase, _i, _ref4, _ref5, _ref6, _ref7, _ref8;
      ...
      if (!this.context) {
        ...
        if (!(typeof varBase.hasProperties === "function" ? varBase.hasProperties() : void 0)) {
          scope = o.scope;
          for (_i = 0, _ref5 = this.upScopes; 0 <= _ref5 ? _i < _ref5 : _i > _ref5; 0 <= _ref5 ? _i++ : _i--) {
            scope = scope.parent;
            if (!scope) {
              throw SyntaxError("top-level identifier \"" + (this.variable.compile(o)) + "\" cannot be exported further");
            }
          }
          if (this.param) {
            scope.add(name, 'var');
      ...
      if (this.upScopes && !scope) {
        throw SyntaxError("non-identifier \"" + (this.variable.compile(o)) + "\" cannot be exported");
      }
  ...
  return exports.walk = walk = function(node, visit) {
    var child, i, item, name, res, _i, _len, _ref4;
    _ref4 = node.children || [];
    for (_i = 0, _len = _ref4.length; _i < _len; _i++) {
      name = _ref4[_i];
      if (!(child = node[name])) {
      ...
      if (child instanceof Array) {
        ...
        while ((res = visit(walk(child, visit)))) {
