...
(function() {
  var Access, Arr, Assign, Base, Block, Call, Class, Closure, Code, CodeFragment, Comment, Existence, Extends, For, IDENTIFIER, IDENTIFIER_STR, IS_STRING, If, In, Index, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, METHOD_DEF, NEGATE, NO, Obj, Op, Param, Parens, RESERVED, Range, Return, SIMPLENUM, STRICT_PROSCRIBED, Scope, Slice, Splat, Switch, TAB, THIS, Throw, Try, UTILITIES, Value, While, YES, addLocationDataFn, cloneNode, compact, createObject, del, ends, extend, flatten, fragmentsToText, last, locationDataToString, merge, multident, some, starts, throwSyntaxError, unfoldSoak, utility, walk, walkArray, _ref, _ref1, _ref2, _ref3;
  ...
  exports.walk = walk = function(node, visit) {
    var child, name, res, _i, _len, _ref4;
    _ref4 = node.children || [];
    for (_i = 0, _len = _ref4.length; _i < _len; _i++) {
      name = _ref4[_i];
      if (child = node[name]) {
  ...
  return walkArray = function(array, visit) {
    var i, item, res;
    i = 0;
    while (item = array[i++]) {
