// Generated by CoffeeScript 1.6.3
  ...
  (function() {
    var Lexer, Macro, Module, SourceMap, binary, child_process, compile, compileFile, ext, fileExtensions, findExtension, fork, formatSourcePosition, fs, getSourceMap, helpers, lexer, loadFile, parser, path, sourceMaps, vm, withPrettyErrors, _i, _len;
    fs = require('fs');
    vm = require('vm');
    path = require('path');
    ...
    exports.compile = compile = withPrettyErrors(function(code, options) {
      var answer, currentColumn, currentLine, fragment, fragments, header, js, map, merge, newLines, nodes, _i, _len;
      merge = helpers.merge;
      ...
      if (options.macro) {
        nodes = Macro.expand(nodes, lexer, parser, options);
      }
