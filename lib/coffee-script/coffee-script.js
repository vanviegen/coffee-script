...
(function() {
  var Lexer, Macro, Module, SourceMap, binary, child_process, compile, compileFile, ext, fileExtensions, findExtension, fork, formatSourcePosition, fs, getSourceMap, helpers, lexer, loadFile, parser, path, sourceMaps, vm, _i, _len;
  fs = require('fs');
  vm = require('vm');
  path = require('path');
  ...
  exports.compile = compile = function(code, options) {
    var answer, ast, fragment, fragments, js, sourceMap;
    if (options == null) {
      options = {};
    }
  ...
  return Error.prepareStackTrace = function(err, stack) {
    ...
    getSourceMapping = function(filename, line, column) {
      ...
      if (answer) {
        return [answer.first_line + 1, answer.first_column + 1];
      } else {
        return null;
      }
    };
